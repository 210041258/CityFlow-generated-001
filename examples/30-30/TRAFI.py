...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python trafi.py --flow flow_30_30_turn.json
  python trafi.py --flow flow_30_30_turn.json --steps 500 --dt 0.5 --model IDM
  python trafi.py --flow flow_30_30_turn.json --no-signals --export
  python trafi.py --steps 200 --road-length 150 --model GIPPS --visualize
        """
    )
    
    parser.add_argument("--flow", type=str, default="flow_30_30_turn.json",
